...
urlpatterns = [
    ...
    path("patients/<uuid:patient_id>/create_medical_record/", dataviews.create_medical_record, name="create_medical_record"),
    ...
    path("patients/<uuid:patient_id>/medical_record/", dataviews.get_medical_record, name="medical_record"),
    ...
    path("get_codes/", dataviews.get_codes, name="codes"),
